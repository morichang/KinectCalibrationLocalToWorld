========================================================================
    コンソール アプリケーション: KinectCalibrationLocalToWorld プロジェクトの概要
========================================================================

この KinectCalibrationLocalToWorld アプリケーションは、AppWizard により作成されました。

このファイルには、KinectCalibrationLocalToWorld アプリケーションを構成する各ファイルの内容の概要が含まれています。


KinectCalibrationLocalToWorld.vcxproj
...
KinectCalibrationLocalToWorld.vcxproj.filters
...
KinectCalibrationLocalToWorld.cpp
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、KinectCalibrationLocalToWorld.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
